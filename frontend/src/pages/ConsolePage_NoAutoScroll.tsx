/**
 * Console logs page component - Auto-scroll disabled
 * Removed automatic scrolling to bottom for better user control
 */
...
export const ConsolePage = () => {
  const { logs, isConnected, connectionStatus, pauseLogging, resumeLogging } = useWebSocketLogs(500);
  ...
  const getPrimarySource = () => {
    ...
    // Get most recent unique sources
    ...
    >
      ...
      <div style={{ flex: 1, minHeight: 0 }}>
        ...
        >
          ...
          {/* Removed logsEndRef div - no more auto-scroll */}
        </div>
      </div>
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <span>
            {isPaused ? 'Logging paused' : 'Live streaming'} • Manual scroll
          </span>
        </div>
      </div>
    </div>
