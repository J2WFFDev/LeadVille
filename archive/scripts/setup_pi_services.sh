...
echo ""
echo "=== Setup Complete ==="
echo "FastAPI Backend: http://pitts:8001/api/health"
echo "Frontend Dev Server: http://pitts:5173"
echo "WebSocket Logs: ws://pitts:8001/ws/logs"
echo "WebSocket Live: ws://pitts:8001/ws/live"
echo ""
